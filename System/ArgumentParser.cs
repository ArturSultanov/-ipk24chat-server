...
/*
 * ArgumentParser is a class that parses the command line arguments and sets the ChatSettings accordingly.
 * It is used to set the server IP, server port, confirmation timeout, and retransmission count.
 */
